...
class UniMolModel(BaseUnicoreModel):
    ...
    def __init__(self, output_dim=2, data_type='molecule', **params):
        ...
        """
        super().__init__()
        if data_type in ['molecule', "molecule_all_h", "molecule_no_h", "peptide_monomer", "peptide_dimer", "peptide_dimer_random", "peptide_dimer_mannual", "peptide_dimer_random_new"]:
